    ...
    return (
        <footer className="bg-dark text-center text-white">
            ...
            <section className="my-1">
                <a className="btn btn-outline-light btn-floating m-1" href="https://github.com/Federico-Cereda/ASPNetCoreReactProducts" target="_blank" rel="noreferrer" role="button">
            ...
            <ul className="list-unstyled mb-0 mx-1 d-inline-block">
                <li>
